...
use rust_ocpp::v1_6::messages::change_configuration::{
    ...
    CLOCK_ALIGNED_DATA_INTERVAL, CONNECTION_TIME_OUT, LOCAL_AUTH_LIST_ENABLED,
    LOCAL_AUTHORIZE_OFFLINE, LOCAL_PRE_AUTHORIZE, MAX_ENERGY_ON_INVALID_ID,
    METER_VALUE_SAMPLE_INTERVAL, METER_VALUES_ALIGNED_DATA, METER_VALUES_SAMPLED_DATA,
