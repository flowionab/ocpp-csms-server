use crate::network_interface::json::handle_new_request::ocpp2_0_1::perform_ocpp_2_0_1_call::perform_ocpp_2_0_1_call;
...
pub async fn handle_ocpp_2_0_1_call<T: Ocpp2_0_1RequestReceiver + Send + Sync + 'static>(
    config: Arc<Config>,
    charger_id: &str,
    charger: Arc<Mutex<T>>,
    ...
    let timer = OCPP_CALLS
        .with_label_values(&[OcppProtocol::Ocpp2_0_1.to_string(), action.clone()])
        .start_timer();
    ...
    let response: Result<Value, OCPP2_0_1Error> = {
        ...
        perform_ocpp_2_0_1_call(duration, lock.deref_mut(), &action, payload).await?
    };
